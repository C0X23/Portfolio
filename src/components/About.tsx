    ...
    <section id="about" className="py-24 bg-white dark:bg-stone-900 transition-colors duration-300">
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <AnimateOnScroll animation="fade-in-left" delay={300} className="w-full lg:w-1/2">
            <div className="relative aspect-square max-w-sm md:max-w-md mx-auto overflow-hidden rounded-2xl bg-stone-100 dark:bg-stone-800 border border-stone-200 dark:border-stone-700 shadow-xl shadow-stone-200/50 dark:shadow-none">
              <Image 
          ...
          <AnimateOnScroll animation="fade-in-right" delay={300} className="w-full lg:w-1/2">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-stone-900 to-stone-500 dark:from-stone-100 dark:to-stone-400 mb-6">
              {t("title")}
            </h2>
            ...
            <div className="grid grid-cols-2 gap-6 text-center md:text-left">
              <div>
                <h4 className="text-4xl font-bold text-stone-900 dark:text-stone-100 mb-2">2+</h4>
